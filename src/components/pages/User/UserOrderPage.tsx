...
const UserOrderPage = async({order}:{order:OrderType}) => {
  ...
  const product = await fetch(`http://localhost:3000/api/products/${order.items[0].productId}`)
